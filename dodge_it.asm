...
CartridgeEntry: JMP  A0cd0               ; 0802 29 0c d0
				...
				; 0, 1
A0805:          LIS  $2                  ; 0805 72 ;0111 0010
                LR   $6,A                ; 0806 56 ;0101 0110
                LR   $2,A                ; 0807 52 ;0101 0010
                LR   $2,A                ; 0808 52 ;0101 0010
                LIS  $7                  ; 0809 77 ;0111 0111
				; 2, 3
                LIS  $7                  ; 080a 77 ;0111 0111
                LR   H,DC                ; 080b 11 ;0001 0001
                LIS  $3                  ; 080c 73 ;0111 0011
                LR   A,$1                ; 080d 41 ;0100 0001
                LIS  $7                  ; 080e 77 ;0111 0111
				; 4, 5
                LR   $7,A                ; 080f 57
                LR   $4,A                ; 0810 54
                LIS  $7                  ; 0811 77
...
A0814:          LR   A,$7                ; 0814 47
				...
				; G ?
                db   $ff                              ;1111 1111
                BT   1,-78               ; 081f 81 b2 ;1000 0001
				                                      ;1011 0010
                BF   $0,A0814            ; 0821 90 f2 ;1001 0000
				                                      ;1111 0010
				; F A
                LIS  $7                  ; 0823 77 ;0111 0111
                LR   A,$5                ; 0824 45 ;0100 0101
                LIS  $7                  ; 0825 77 ;0111 0111
                LR   A,$5                ; 0826 45 ;0100 0101
                LR   A,$5                ; 0827 45 ;0100 0101
				; S T
                LIS  $7                  ; 0828 77 ;0111 0111
                LR   A,$2                ; 0829 42 ;0100 0010
                LIS  $2                  ; 082a 72 ;0111 0010
                SR   1                   ; 082b 12 ;0001 0010
                LIS  $2                  ; 082c 72 ;0111 0010
...
A0850:          LR   A,$0                ; 0850 40
                ...
                BT   0,0                 ; 0852 80 00 ; Data at 0853
                LR   A,KL                ; 0854 01
                LR   A,QU                ; 0855 02
                LR   A,QL                ; 0856 03
                LR   A,QL                ; 0857 03
...
; Do one row
A0866:          
				; Mask out row, put sound (color?) in r8
				LR   A,$2                ; 0866 42
                NI   $c0                 ; 0867 21 c0
                LR   $8,A                ; 0869 58
...
A0ef1:          LR   A,(IS)              ; 0ef1 4c
                ...
                ASD  (IS)                ; 0ef6 dc
                LR   (IS)+,A             ; 0ef7 5d
                PI   A0a20               ; 0ef8 28 0a 20 ; Score display
				; Read controllers
